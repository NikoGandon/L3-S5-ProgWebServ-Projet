...
MessageModel.hasMany(MessageGroupe, { foreignKey: "idMessage" });
GroupeModel.hasMany(MessageGroupe, { foreignKey: "idGroupe" });
UserModel.hasMany(MessageGroupe, { foreignKey: "idAuteur", as: "Auteur" });
